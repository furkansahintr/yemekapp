...
function injectTokens() {
  ...
  root.style.setProperty(
    "--primary-deep",
    isDark ? t.primaryDeep : TOKENS.colors.primaryDeep,
  );
  root.style.setProperty(
    "--primary-light",
    isDark ? t.primaryLight : TOKENS.colors.primaryLight,
  );
  root.style.setProperty("--primary-soft", TOKENS.colors.primarySoft);
  root.style.setProperty(
    "--secondary",
    isDark ? t.secondary || TOKENS.colors.secondary : TOKENS.colors.secondary,
  );
  root.style.setProperty(
    "--tertiary",
    isDark ? t.tertiary || TOKENS.colors.tertiary : TOKENS.colors.tertiary,
  );
