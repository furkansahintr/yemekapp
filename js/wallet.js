...
function _wltInjectStyles() {
  ...
  parts.push(
    ...
    '.wlt-header{position:sticky;top:0;display:flex;align-items:center;gap:12px;padding:14px 16px;background:var(--bg-phone);border-bottom:1px solid var(--border-subtle);z-index:5}',
    '.wlt-back{width:34px;height:34px;border-radius:10px;background:var(--bg-surface);display:flex;align-items:center;justify-content:center;cursor:pointer;color:var(--text-primary);transition:transform .15s}',
  ...
  parts.push(
    ...
    '/* Daily limit */',
    '.wlt-limit{padding:10px 12px;background:var(--bg-surface);border-radius:12px;display:flex;flex-direction:column;gap:7px}',
  ...
  parts.push(
    ...
    '.wlt-tx-count{font-size:10px;font-weight:700;background:var(--bg-surface);color:var(--text-muted);padding:2px 8px;border-radius:6px}',
    '.wlt-tx-list{background:var(--bg-phone);border:1px solid var(--border-subtle);border-radius:14px;overflow:hidden}',
    '.wlt-tx{display:flex;align-items:center;gap:10px;padding:11px 12px;border-bottom:1px solid var(--border-subtle);cursor:pointer;transition:background .15s}',
    '.wlt-tx:last-child{border-bottom:none}',
    '.wlt-tx:hover,.wlt-tx:active{background:var(--bg-surface)}',
  ...
  parts.push(
    ...
    '.wlt-step-dot{flex:1;height:4px;border-radius:999px;background:var(--bg-surface);transition:background .25s}',
    ...
    '.wlt-btn-ghost{padding:12px 18px;border:1px solid var(--border-subtle);background:transparent;color:var(--text-primary);border-radius:12px;font-size:13px;font-weight:600;cursor:pointer}',
    ...
    '/* Generic inputs */',
    '.wlt-inp{padding:11px 13px;border:1.5px solid var(--border-subtle);background:var(--bg-surface);color:var(--text-primary);border-radius:10px;font-size:13px;outline:none;font-family:inherit;transition:border-color .18s}',
    ...
    '/* Summary card (shared) */',
    '.wlt-sum-card{background:var(--bg-surface);border-radius:12px;padding:11px 13px;display:flex;flex-direction:column;gap:7px}',
    ...
    '.wlt-sum-row--hl{padding-top:7px;border-top:1px dashed var(--border-subtle);margin-top:4px}',
  ...
  parts.push(
    ...
    '.wlt-amount-card{background:linear-gradient(135deg,rgba(16,185,129,.08),rgba(139,92,246,.06));border:1px solid var(--border-subtle);border-radius:14px;padding:14px 13px;display:flex;flex-direction:column;gap:8px}',
    ...
    '.wlt-preset-chip{padding:9px 4px;border:1.5px solid var(--border-subtle);background:var(--bg-phone);color:var(--text-primary);border-radius:10px;font-size:12px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:3px;transition:all .18s;font-family:inherit}',
    ...
    '.wlt-card-row{display:flex;align-items:center;gap:11px;padding:11px 12px;background:var(--bg-phone);border:1.5px solid var(--border-subtle);border-radius:12px;cursor:pointer;transition:all .15s}',
    ...
    '.wlt-card-brand--new{background:var(--bg-surface);color:var(--text-muted);border:1.5px dashed var(--border-subtle)}',
    ...
    '/* New card form */',
    '.wlt-new-card-form{background:var(--bg-surface);border-radius:12px;padding:12px;display:flex;flex-direction:column;gap:8px;margin-top:-4px}',
    ...
    '.wlt-success-box{width:100%;background:var(--bg-surface);border-radius:12px;padding:12px;display:flex;flex-direction:column;gap:6px;text-align:left;margin-bottom:12px}'
  );

  // ── P5.6 Share akışı ──
  parts.push(
    '/* Search */',
    '.wlt-search{display:flex;align-items:center;gap:8px;padding:10px 12px;background:var(--bg-surface);border-radius:12px}',
    ...
    '.wlt-friend-row{display:flex;align-items:center;gap:11px;padding:10px 12px;background:var(--bg-phone);border:1px solid var(--border-subtle);border-radius:12px;cursor:pointer;transition:transform .15s}',
    '.wlt-friend-row:active{transform:scale(.98)}',
    '.wlt-friend-avatar{width:40px;height:40px;border-radius:50%;object-fit:cover;border:2px solid var(--bg-surface);flex-shrink:0}',
    ...
    '/* Limit info 3-col */',
    '.wlt-limit-info{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;background:var(--bg-surface);border-radius:12px;padding:11px 10px}',
  ...
  parts.push(
    ...
    '/* Balance compare */',
    '.wlt-bal-compare{background:var(--bg-surface);border-radius:12px;padding:12px 14px;display:flex;flex-direction:column;gap:4px}',
  ...
  parts.push(
    ...
    '.wlt-confirm-meta{font-size:11px;color:var(--text-muted);background:var(--bg-surface);padding:8px 10px;border-radius:10px;margin-bottom:12px;font-variant-numeric:tabular-nums}',
    ...
    '.wlt-info-row{display:flex;gap:8px;padding:10px 12px;background:var(--bg-surface);border-radius:10px;font-size:12px;color:var(--text-primary);line-height:1.55}',
